...
// declare module "node-svd" {
//   export var svd: (x: number[][]) => void;
// }
...
declare module "sylvester" {
  ...
  interface MatrixStatic {
       ...
       * @param {number} m The number of columns.
       */
      Zeros(n: number, m: number): Matrix;
      
      One(n: number, m: number): Matrix;
      Ones(n: number, m: number): Matrix;
  }
  ...
  interface Matrix {
      ...
      pcaProject(k: number, U?: Matrix): { Z: Matrix, U: Matrix };
      pcaRecover(U: Matrix): Matrix;
      triu(k?: number): Matrix;
      unroll(): Vector;
      slice(startRow: number, endRow: number, startCol: number, endCol: number): Matrix;
      approxEql(matrix: Matrix): boolean;
      mulOp(matrix: Matrix | Vector, op: (x: number, y: number) => number): Vector | Matrix;
      div(matrix: Matrix | Vector): Matrix | Vector;
      elementMultiply(v: Matrix): Matrix;
      sum(): number;
      mean(): Vector;
      column(): Vector;
      log(): Matrix;
      toArray(): number[][];
      maxColumnIndexes(): Vector;
      maxColumns(): Vector;
      minColumnIndexes(): Vector;
      minColumns(): Vector;
      partialPivot(k: number, j: number, P: Matrix, A: Matrix): Matrix;
      forwardSubstitute(b: Vector): Vector;
      backSubstitute(b: Vector): Vector;
  ...
  export var Vector: VectorStatic;
  export var Matrix: MatrixStatic;
  export var Line: LineStatic;
  export var Plane: PlaneStatic;
  ...
  */
  export function $V(elements: Vector|Array<number>): Vector;
  ...
  * @param {Array<number>|Array<Array<number>>|Vector|Matrix} elements The elements.
  */
  export function $M(elements: Array<number>|Array<Array<number>>|Vector | Matrix): Matrix;
  ...
  * @param Array<number>|Vector direction The direction vector.
  */
  export function $L(anchor: Array<number>|Vector, direction: Array<number>|Vector): Line;
  ...
  * @param {Array<number>|Vector} normal The normal vector.
  */
  export function $P(anchor: Array<number>|Vector, normal: Array<number>|Vector): Plane;
   ...
   */
  export function $P(anchor: Array<number>|Vector, v1: Array<number>|Vector, v2: Array<number>|Vector): Plane;
}
...
declare module "level" {
    ...
    interface LevelUpBase<BatchType extends Batch> {
        ...
        put<K, V>(key: K, value: V, callback: (error: any) => any): void;
        put<K, V>(key: K, value: V, options: { sync?: boolean }, callback: (error: any) => any): void;
        get<K, V>(key: K, callback: (error: any, value: V) => any): void;

        get<K, V>(key: K, options: { keyEncoding?: Encoding; fillCache?: boolean }, callback: (error: any, value: V) => any): void;
        del<K>(key: K, callback: (error: any) => any): void;
        del<K>(key: K, options: { keyEncoding?: Encoding; sync?: boolean }, callback: (error: any) => any): void;

        put<K, V>(key: K, value: V): Promise<void>;
        put<K, V>(key: K, value: V, options: { sync?: boolean }): Promise<void>;
        get<K, V>(key: K): Promise<V>;

        get<K, V>(key: K, options: { keyEncoding?: Encoding; fillCache?: boolean }): Promise<V>;
        del<K>(key: K): Promise<void>;
        del<K>(key: K, options: { keyEncoding?: Encoding; sync?: boolean }): Promise<void>;
        ...
        batch(array: BatchType[], options: { keyEncoding?: Encoding; valueEncoding?: Encoding; sync?: boolean }): Promise<void>;
        batch(array: BatchType[]): Promise<void>;
